...
- **Never use em-dashes (—)** in documentation or any other files. Use a hyphen with surrounding spaces ( - ), commas, or parentheses instead, whichever reads best in context.
