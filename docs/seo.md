...
dedicated [robots.txt](robotstxt.md) page.
...
Once generated, reference the sitemap file from your [robots.txt](robotstxt.md) so crawlers can
find it.
...
You typically reinforce this in [robots.txt](robotstxt.md) by disallowing checkout, customer
...
setups can tune crawl behavior independently. Pair them with a tailored [robots.txt](robotstxt.md)
