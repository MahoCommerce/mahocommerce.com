...
[autoloaders](../developer/composer-plugin.md), removing the need for the original M1 composer plugin to copy (and duplicate)
...
To know more, check the [complete documentation of Maho's CLI tool](../developer/cli-tool.md).
...
This is why, at Maho, we decided to maintain internally both the [CLI tool](../developer/cli-tool.md), the
