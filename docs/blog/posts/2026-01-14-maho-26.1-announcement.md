...
Welcome to **Triple Heart**, a landmark release that fundamentally expands what Maho can do. This version introduces **multi-database support** (MySQL, PostgreSQL, and SQLite), **passwordless authentication** via magic links, and a **complete gift card module** built right into the core. We've continued our modernization journey with Symfony 7.4, achieved PHP 8.5 compatibility, and added powerful new CLI tools for developers.
