...
```php
/* ... */
$this->addAttribute('complexworld_eavblogpost', 'title', [
...
$this->addAttribute('complexworld_eavblogpost', 'content', [
    'type'              => 'text',
    'label'             => 'Content',
    'input'             => 'textarea',
]);
$this->addAttribute('complexworld_eavblogpost', 'date', [
    'type'              => 'datetime',
    'label'             => 'Post Date',
    'input'             => 'datetime',
    'required'          => false,
