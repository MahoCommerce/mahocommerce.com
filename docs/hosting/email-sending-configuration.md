---
description: Configure Maho's built-in SMTP email sending, powered by Symfony Mailer, for reliable delivery of order confirmations, password resets and notifications.
---
